...
OPTION_TYPES: dict[str, Any] = {
    ...
    "catlink-osx-recover-mouse-down": bool,
    "catlink-osx-recover-mouse-down-max-age": float,
    "catlink-osx-recover-mouse-down-distance-warn-threshold": int,
...
CLIENT_OPTIONS: list[str] = [
    ...
    "catlink-osx-recover-mouse-down",
    "catlink-osx-recover-mouse-down-max-age",
...
def get_defaults() -> dict[str, Any]:
    ...
    GLOBAL_DEFAULTS = {
        ...
        "catlink-osx-recover-mouse-down": True,
        "catlink-osx-recover-mouse-down-max-age": 3.0,
        "catlink-osx-recover-mouse-down-distance-warn-threshold": 24,
